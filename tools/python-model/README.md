...
specification v0.6 and maintained to v0.7, v0.8, and v0.8.1 in bounded
clean-room maintenance passes (see `AUTHORING-RECORD.md`).  Its purpose is
...
unspecified exact error for multi-fault inputs).
`tests/test_v081_conformance.py` reproduces the v0.8.1 Appendix B.12
fault-isolated schema-disallowed-simple-value vectors against
`fixtures/specification/appendix_b_v081.json` and asserts the exact
